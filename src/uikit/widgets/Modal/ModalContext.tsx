...
interface ModalsContext {
  ...
  onPresent: (node: React.ReactNode, newNodeId: string, shouldCloseOnOverlayClick?: boolean) => void
  onDismiss: Handler
...
const ModalProvider: React.FC = ({ children }) => {
  ...
  const handlePresent = (node: React.ReactNode, newNodeId: string, shouldCloseOnOverlayClick = true) => {
    if (closeOnOverlayClick !== shouldCloseOnOverlayClick) {
